const comparisons = [
  {
    ...
    us: "Prospects 100% exclusifs pour vous"
  },
  {
    others: "Contacts qui ne correspondent pas à votre ICP",
    us: "Entreprises qui ont besoin de votre solution"
  },
  {
    others: "Agences qui ne comprennent pas le SaaS",
    us: "Une équipe qui connaît votre écosystème"
  },
  {
    others: "Engagement longue durée obligatoire",
    us: "Aucun engagement. Test d'un mois."
  },
];

export const ComparisonSectionSaaS = () => {
  return (
