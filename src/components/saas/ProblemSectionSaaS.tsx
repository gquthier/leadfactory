const frustrations = [
  { emoji: "❌", text: "Prospecter des entreprises qui n'ont pas de budget pour votre solution" },
  { emoji: "😤", text: "Perdre du temps avec des curieux qui ne passeront jamais à l'action" },
  { emoji: "⏰", text: "Faire des démonstrations à des gens qui n'ont pas le pouvoir de décision" },
  { emoji: "📉", text: "Avoir un pipeline rempli de prospects qui ne convertissent jamais" },
  { emoji: "💸", text: "Dépenser une fortune en publicités pour attirer n'importe qui" },
];

export const ProblemSectionSaaS = () => {
  return (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 brutalist-card bg-[#FFC4EB] text-center max-w-2xl mx-auto">
            <p className="text-3xl font-black uppercase mb-2 text-black leading-tight">
              ON CONNAÎT LE MONDE DU SAAS.
            </p>
            <p className="text-2xl font-bold text-black leading-tight">
              On a créé <span className="italic">Lead Factory</span> pour que vous parliez aux bonnes personnes.
            </p>
          </div>
        </div>
      </div>
