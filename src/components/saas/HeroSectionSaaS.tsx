      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-4 gap-8 items-center">
          ...
          <div className="lg:col-span-3 text-left relative">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight tracking-tight mb-6">
              On vous trouve des entreprises qui ont besoin de votre SaaS.
              <br />
        ...
        <div className="mt-32 mb-4 grid grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="brutalist-card text-center bg-white">
            <p className="text-4xl lg:text-5xl font-black text-black mb-2">150+</p>
            <p className="text-sm font-bold uppercase tracking-wider">DÉMONSTRATIONS</p>
          </div>
          <div className="brutalist-card text-center bg-[#3B82F6]">
            <p className="text-4xl lg:text-5xl font-black text-white mb-2">300k€</p>
            <p className="text-sm font-bold uppercase tracking-wider text-white">ARR GÉNÉRÉ</p>
          </div>
          <div className="brutalist-card text-center bg-[#FDE047]">
            <p className="text-4xl lg:text-5xl font-black text-black mb-2">+30</p>
            <p className="text-sm font-bold uppercase tracking-wider text-black">SAAS ACCOMPAGNÉS</p>
          </div>
