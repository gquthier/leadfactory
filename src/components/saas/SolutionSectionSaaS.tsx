...
const pillars = [
  {
    icon: Users,
    title: "Des entreprises avec un vrai besoin",
    description: "On cible des entreprises qui ont des problèmes que votre SaaS peut résoudre. Pas des curieux.",
  },
  {
    icon: Shield,
    title: "Des décideurs avec un budget",
    description: "On parle aux personnes qui ont le pouvoir de dire oui et les moyens de payer.",
  },
  {
    icon: Zap,
...
export const SolutionSectionSaaS = () => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          <h2 className="responsive-headline mb-8">
            ...
            <br />
            <span className="text-2xl lg:text-4xl">VOUS FAITES VOS DÉMOS.</span>
          </h2>
        </div>
