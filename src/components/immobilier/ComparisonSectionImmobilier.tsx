const comparisons = [
  { others: "Leads partagés entre plusieurs agences", us: "Contacts 100% exclusifs pour vous" },
  { others: "Curieux sans projet concret", us: "Porteurs de projet vente/achat avec intention" },
  { others: "Dépendance aux portails surchargés", us: "Acquisition directe de prospects qualifiés" },
  { others: "Engagement 12 mois minimum", us: "Test d'un mois. Aucun engagement." },
];

export const ComparisonSectionImmobilier = () => {
  return (
