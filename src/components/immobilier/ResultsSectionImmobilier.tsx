...
export const ResultsSectionImmobilier = () => {
    ...
    <section id="results" className="py-24 lg:py-32 bg-[#FFFDF5] relative border-b-3 border-black">
      <div className="container mx-auto px-6 lg:px-12 mb-16">
        <div className="text-center">
          <h2 className="responsive-headline mb-8">ILS ONT{" "}<span className="italic text-[#3B82F6] transform -skew-x-12 inline-block">TESTÉ.</span><br /><span className="text-2xl lg:text-4xl">ILS ONT SIGNÉ.</span></h2>
          <div className="pill-container inline-block bg-[#3B82F6]"><p className="text-xl font-bold text-white">🎯 Témoignages clients • 100% authentiques</p></div>
        </div>
      </div>
