const comparisons = [
  { others: "Publicités Facebook génériques qui coûtent cher", us: "Publicités ciblées sur vos vrais acheteurs" },
  { others: "Trafic de masse qui ne convertit pas", us: "Visiteurs qualifiés prêts à acheter" },
  { others: "Agences qui ne comprennent pas l'e-commerce", us: "Une équipe qui connaît la vente en ligne" },
  { others: "Contrats longue durée sans garantie", us: "Test d'un mois. Aucun engagement." },
];
export const ComparisonSectionEcommerce = () => {
  return (
    <section className="py-24 lg:py-32 bg-[#FFFDF5] relative border-b-3 border-black">
      <div className="container mx-auto px-6 lg:px-12"><div className="text-center mb-16"><h2 className="responsive-headline mb-8">ON N'EST PAS{" "}<span className="italic text-[#3B82F6] transform -skew-x-12 inline-block">COMME</span><br /><span className="text-2xl lg:text-4xl">LES AUTRES.</span></h2><div className="pill-container inline-block bg-[#FDE047]"><p className="text-xl font-bold">⚖️ Comparaison avec la concurrence</p></div></div>
