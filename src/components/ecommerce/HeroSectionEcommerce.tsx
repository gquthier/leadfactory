...
export const HeroSectionEcommerce = () => {
  return (
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-4 gap-8 items-center">
          <div className="lg:col-span-3 text-left relative">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight tracking-tight mb-6">
              On vous trouve des clients prêts à acheter.
              <br />
            ...
            <div className="mb-8 flex flex-wrap gap-2 max-w-4xl">
              <div className="bg-white border-3 border-black rounded-full px-4 py-2 shadow-[4px_4px_0px_0px_#000000] whitespace-nowrap">
                <p className="text-sm font-bold">🎯 Acheteurs qualifiés</p>
              </div>
              <div className="bg-white border-3 border-black rounded-full px-4 py-2 shadow-[4px_4px_0px_0px_#000000] whitespace-nowrap">
        ...
        <div className="mt-32 mb-4 grid grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="brutalist-card text-center bg-white">
            <p className="text-4xl lg:text-5xl font-black text-black mb-2">1200+</p>
            <p className="text-sm font-bold uppercase tracking-wider">COMMANDES</p>
          </div>
          <div className="brutalist-card text-center bg-[#3B82F6]">
            <p className="text-4xl lg:text-5xl font-black text-white mb-2">800k€</p>
            <p className="text-sm font-bold uppercase tracking-wider text-white">CA GÉNÉRÉ</p>
          </div>
          <div className="brutalist-card text-center bg-[#FDE047]">
            <p className="text-4xl lg:text-5xl font-black text-black mb-2">+25</p>
            <p className="text-sm font-bold uppercase tracking-wider text-black">ECOMMERCE ACCOMPAGNÉS</p>
          </div>
