...
export const HeroSectionServicesB2B = () => {
  return (
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-4 gap-8 items-center">
          <div className="lg:col-span-3 text-left relative">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight tracking-tight mb-6">
              On vous trouve des entreprises qui ont besoin de vos services.
              <br />
            ...
            <div className="mb-8 flex flex-wrap gap-2 max-w-4xl">
              <div className="bg-white border-3 border-black rounded-full px-4 py-2 shadow-[4px_4px_0px_0px_#000000] whitespace-nowrap">
                <p className="text-sm font-bold">🎯 Entreprises qualifiées</p>
              </div>
              <div className="bg-white border-3 border-black rounded-full px-4 py-2 shadow-[4px_4px_0px_0px_#000000] whitespace-nowrap">
                <p className="text-sm font-bold">⚡ Sans engagement • Résultats 15j</p>
              </div>
              <div className="bg-white border-3 border-black rounded-full px-4 py-2 shadow-[4px_4px_0px_0px_#000000] whitespace-nowrap">
                <p className="text-sm font-bold">💰 À partir de 690€</p>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button className="bg-black text-white border-3 border-black px-6 py-3 font-bold uppercase tracking-wider shadow-[4px_4px_0px_0px_#000000] hover:shadow-[2px_2px_0px_0px_#000000] hover:translate-x-[2px] hover:translate-y-[2px] transition-all text-sm flex items-center justify-center">
        ...
        <div className="mt-32 mb-4 grid grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="brutalist-card text-center bg-white">
            <p className="text-4xl lg:text-5xl font-black text-black mb-2">300+</p>
            <p className="text-sm font-bold uppercase tracking-wider">RENDEZ-VOUS</p>
          </div>
          <div className="brutalist-card text-center bg-[#3B82F6]">
            <p className="text-4xl lg:text-5xl font-black text-white mb-2">2M€</p>
            <p className="text-sm font-bold uppercase tracking-wider text-white">DEALS GÉNÉRÉS</p>
          </div>
          <div className="brutalist-card text-center bg-[#FDE047]">
            <p className="text-4xl lg:text-5xl font-black text-black mb-2">+60</p>
            <p className="text-sm font-bold uppercase tracking-wider text-black">SERVICES ACCOMPAGNÉS</p>
          </div>
