const comparisons = [
  { others: "Leads partagés avec vos concurrents", us: "Prospects 100% exclusifs pour vous" },
  { others: "Contacts qui ne correspondent pas à vos services", us: "Entreprises qui ont besoin de vous" },
  { others: "Agences qui ne comprennent pas vos métiers", us: "Une équipe qui connaît le B2B" },
  { others: "Engagement longue durée obligatoire", us: "Aucun engagement. Test d'un mois." },
];

export const ComparisonSectionServicesB2B = () => {
  return (
