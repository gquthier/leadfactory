const frustrations = [
  { emoji: "❌", text: "Recevoir des demandes de gens qui veulent juste comparer les prix" },
  { emoji: "😤", text: "Perdre du temps avec des personnes hors de votre secteur" },
  { emoji: "⏰", text: "Attendre que le bouche-à-oreille fonctionne" },
  { emoji: "📉", text: "Avoir des clients ponctuels au lieu de réguliers" },
  { emoji: "💸", text: "Courir après de nouveaux clients chaque mois" }
];

export const ProblemSectionServicesPersonne = () => {
  return (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 brutalist-card bg-[#FFC4EB] text-center max-w-2xl mx-auto">
            <p className="text-3xl font-black uppercase mb-2 text-black leading-tight">
              ON COMPREND LES SERVICES À LA PERSONNE.
            </p>
            <p className="text-2xl font-bold text-black leading-tight">
              On a créé <span className="italic">Lead Factory</span> pour vous mettre en contact avec des familles qui cherchent une solution durable.
            </p>
          </div>
        </div>
      </div>
