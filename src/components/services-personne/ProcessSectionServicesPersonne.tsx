...
const steps = [
  {
    ...
    description: "Vous nous expliquez vos services, votre zone d'intervention, le type de clients que vous recherchez.",
    icon: BarChart3
  },
  {
    number: "02",
    title: "ON CRÉE TOUT POUR VOUS",
    description: "Vidéos, visuels, site web, publicités ciblées dans votre secteur.",
    icon: Rocket
  },
  {
    number: "03",
    title: "VOUS RECEVEZ DES DEMANDES",
    description: "Des familles vous contactent avec leur besoin. Vous les rencontrez, vous proposez, vous démarrez.",
    icon: Trophy
  }
];

export const ProcessSectionServicesPersonne = () => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="mt-16 brutalist-card bg-[#FDE047] text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl font-bold text-black">
            <span className="italic">Nous, on remplit votre agenda.</span> 🏠💙
          </p>
        </div>
      </div>
    </section>
