...
const pillars = [
  {
    icon: Users,
    title: "Des particuliers dans votre zone",
    description: "On cible uniquement les familles de votre secteur géographique. Pas de déplacements impossibles."
  },
  {
    icon: Shield,
    title: "Des gens qui cherchent du régulier",
    description: "Pas des demandes ponctuelles. Des familles qui veulent une aide sur la durée."
  },
  {
    icon: Zap,
    title: "Zéro engagement, zéro risque",
    description: "Testez un mois. Voyez les demandes. Décidez ensuite."
  }
];

export const SolutionSectionServicesPersonne = () => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          <h2 className="responsive-headline mb-8">
            ...
            <br />
            <span className="text-2xl lg:text-4xl">VOUS ACCOMPAGNEZ VOS CLIENTS.</span>
          </h2>
        </div>
        ...
        <div className="mt-16 brutalist-card bg-[#3B82F6] text-center max-w-4xl mx-auto">
          <h3 className="text-3xl font-black uppercase mb-2 text-white leading-tight">
            DES FAMILLES QUI CHERCHENT DU LONG TERME
          </h3>
