const comparisons = [
  { others: "Plateformes qui mettent en concurrence", us: "Contacts directs, sans intermédiaire" },
  { others: "Demandes hors de votre zone", us: "Ciblage précis de votre secteur" },
  { others: "Prospects qui comparent juste le prix", us: "Familles qui cherchent la bonne personne" },
  { others: "Engagement longue durée", us: "Test d'un mois sans engagement" },
];

export const ComparisonSectionServicesPersonne = () => {
  return (
