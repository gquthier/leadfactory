...
const steps = [
  {
    ...
    description: "Vous nous expliquez votre établissement, votre clientèle idéale, vos périodes à remplir.",
    icon: BarChart3
  },
  {
    number: "02",
    title: "ON CRÉE TOUT POUR VOUS",
    description: "Vidéos, visuels, page de réservation, publicités ciblées sur vos voyageurs idéaux.",
    icon: Rocket
  },
  {
    number: "03",
    title: "VOUS RECEVEZ DES RÉSERVATIONS",
    description: "Des clients réservent directement chez vous. Sans intermédiaire, sans commission.",
    icon: Trophy
  }
];

export const ProcessSectionTourisme = () => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="mt-16 brutalist-card bg-[#FDE047] text-center max-w-4xl mx-auto">
          <h3 className="text-2xl font-black uppercase mb-4">
            PENDANT CE TEMPS, VOUS VOUS OCCUPEZ DE VOS CLIENTS.
          </h3>
          <p className="text-xl font-bold text-black">
            <span className="italic">Nous, on remplit votre agenda.</span> 🏨✈️
          </p>
        </div>
      </div>
    </section>
