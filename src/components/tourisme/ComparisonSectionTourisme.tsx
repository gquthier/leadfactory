const comparisons = [
  { others: "15-25% de commission sur chaque réservation", us: "Réservations directes, 0% de commission" },
  { others: "Clients qui ne connaissent pas votre établissement", us: "Voyageurs qui vous ont choisi vous" },
  { others: "Dépendance aux algorithmes des plateformes", us: "Votre propre canal d'acquisition" },
  { others: "Pas de contrôle sur votre visibilité", us: "Vous décidez quand et combien investir" },
];

export const ComparisonSectionTourisme = () => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          <h2 className="responsive-headline mb-8">
            ON N'EST PAS{" "}
            <span className="italic text-[#3B82F6] transform -skew-x-12 inline-block">COMME</span>
            <br />
            <span className="text-2xl lg:text-4xl">LES AUTRES.</span>
          </h2>
          <div className="pill-container inline-block bg-[#FDE047]">
            <p className="text-xl font-bold">⚖️ Comparaison avec la concurrence</p>
          </div>
        </div>
        ...
        <div className="bg-white border-3 border-black p-8 relative shadow-[16px_16px_0px_0px_#000000] max-w-5xl mx-auto overflow-hidden" style={{backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 10px, rgba(0,0,0,0.1) 10px, rgba(0,0,0,0.1) 12px)'}}>
          ...
          <div className="border-t-4 border-dashed border-black mt-8 pt-8 text-center">
            <div className="brutalist-card bg-[#FDE047] inline-block">
              <p className="text-2xl font-black">LA DIFFÉRENCE EST ÉVIDENTE 🏆</p>
            </div>
          </div>
        </div>
      </div>
