const frustrations = [
  { emoji: "❌", text: "Payer 15-25% de commission à Booking ou Airbnb sur chaque réservation" },
  { emoji: "😤", text: "Dépendre des plateformes pour remplir votre établissement" },
  { emoji: "⏰", text: "Ne pas connaître vos clients avant qu'ils arrivent" },
  { emoji: "📉", text: "Avoir des périodes creuses impossibles à remplir" },
  { emoji: "💸", text: "Voir vos marges fondre à cause des commissions" }
];

export const ProblemSectionTourisme = () => {
  return (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 brutalist-card bg-[#FFC4EB] text-center max-w-2xl mx-auto">
            <p className="text-3xl font-black uppercase mb-2 text-black leading-tight">
              ON COMPREND LA DÉPENDANCE AUX PLATEFORMES.
            </p>
            <p className="text-2xl font-bold text-black leading-tight">
              On a créé <span className="italic">Lead Factory</span> pour vous ramener des réservations en direct, sans intermédiaire.
            </p>
          </div>
        </div>
      </div>
