const frustrations = [
  { emoji: "❌", text: "Recevoir des demandes de stagiaires ou d'assistants sans pouvoir de décision" },
  { emoji: "😤", text: "Passer des semaines à qualifier des contacts qui n'ont pas de budget" },
  { emoji: "⏰", text: "Perdre du temps avec des \"projets\" qui n'en sont pas vraiment" },
  { emoji: "📉", text: "Prospecter dans le vide sans résultats concrets" },
  { emoji: "💸", text: "Payer des agences qui ne comprennent rien à vos sujets techniques" },
];

export const ProblemSectionESN = () => {
  return (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 brutalist-card bg-[#FFC4EB] text-center max-w-2xl mx-auto">
            <p className="text-3xl font-black uppercase mb-2 text-black leading-tight">
              ON CONNAÎT LE MONDE DES ESN.
            </p>
            <p className="text-2xl font-bold text-black leading-tight">
              On a créé <span className="italic">Lead Factory</span> pour remplir votre pipe de vrais projets.
            </p>
          </div>
        </div>
      </div>
