...
const steps = [
  {
    ...
    description: "Vous nous expliquez vos expertises, vos clients idéaux, la taille de projets que vous cherchez.",
    icon: BarChart3,
  },
  {
    number: "02", 
    title: "ON CRÉE TOUT POUR VOUS",
    description: "Vidéos, visuels, site, publicités ciblées sur les décideurs IT.",
    icon: Rocket,
  },
  {
    number: "03",
    title: "VOUS RECEVEZ DES DEMANDES DE RDV",
    description: "Des DSI et responsables IT vous contactent. Vous qualifiez, vous présentez, vous signez.",
    icon: Trophy,
  },
];

export const ProcessSectionESN = () => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="mt-16 brutalist-card bg-[#FDE047] text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl font-bold text-black">
            <span className="italic">Nous, on remplit votre pipe de vrais projets IT.</span> 💼✨
          </p>
        </div>
      </div>
    </section>
