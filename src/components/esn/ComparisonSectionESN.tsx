const comparisons = [
  {
    others: "Contacts partagés avec 5 ESN concurrentes",
    us: "Contacts 100% exclusifs pour vous"
  },
  {
    others: "Formulaires de \"demande d'info\" vagues",
    us: "Demandes de rendez-vous qualifiées"
  },
  {
    others: "Agences qui ne comprennent pas l'IT",
    us: "Une équipe qui connaît votre marché"
  },
  {
    others: "Engagement 12 mois minimum",
    us: "Aucun engagement. Test d'un mois."
  },
];

export const ComparisonSectionESN = () => {
  return (
