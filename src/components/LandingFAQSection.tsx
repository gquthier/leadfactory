...
const faqs = [
  {
    ...
    answer: "C'est pour ça qu'on propose un test sans engagement. Vous voyez les résultats avant de vous engager sur la durée. Si ça ne vous convient pas, vous partez. Sans justification.",
  },
  {
  ...
  },
  {
    ...
    answer: "Il n'y en a pas. Un test complet sans engagement. Si vous voulez continuer après, on en discute. Si vous voulez arrêter, vous arrêtez.",
  },
  {
