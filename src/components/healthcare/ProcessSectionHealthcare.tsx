...
const steps = [
  {
    ...
    description: "Vous nous expliquez vos spécialités, votre zone, les créneaux que vous voulez remplir.",
    icon: BarChart3
  },
  {
    number: "02",
    title: "ON CRÉE TOUT POUR VOUS",
    description: "Vidéos, visuels, page web, publicités conformes aux règles du secteur.",
    icon: Rocket
  },
  {
    number: "03",
    title: "VOUS RECEVEZ DES DEMANDES",
    description: "Des patients vous contactent pour prendre rendez-vous. Vous les recevez, vous les soignez.",
    icon: Trophy
  }
];

export const ProcessSectionHealthcare = () => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="mt-16 brutalist-card bg-[#FDE047] text-center max-w-4xl mx-auto">
          <h3 className="text-2xl font-black uppercase mb-4">
            PENDANT CE TEMPS, VOUS VOUS OCCUPEZ DE VOS PATIENTS.
          </h3>
          <p className="text-xl font-bold text-black">
            <span className="italic">Nous, on remplit votre planning.</span> 🏥⚕️
          </p>
        </div>
      </div>
    </section>
