const comparisons = [
  { others: "Publicités non conformes au secteur santé", us: "Campagnes respectueuses des réglementations" },
  { others: "Patients qui ne se présentent pas", us: "Demandes qualifiées de gens engagés" },
  { others: "Solutions génériques", us: "Ciblage sur vos spécialités précises" },
  { others: "Engagement longue durée", us: "Test d'un mois sans engagement" },
];

export const ComparisonSectionHealthcare = () => {
  return (
