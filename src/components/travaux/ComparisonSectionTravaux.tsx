const comparisons = [
  { others: "Contacts vendus à 5-10 artisans", us: "Contacts 100% exclusifs pour vous" },
  { others: "Prospects froids qui ne répondent pas", us: "Propriétaires qui attendent votre appel" },
  { others: "Plateformes automatiques sans humain", us: "Une vraie équipe qui optimise vos pubs" },
  { others: "Abonnement obligatoire", us: "Test d'un mois sans engagement" },
];

export const ComparisonSectionTravaux = () => {
  return (
