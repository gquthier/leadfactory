...
const steps = [
  {
    ...
    description: "Vous nous dites vos spécialités, votre zone, le type de chantiers que vous voulez.",
    icon: BarChart3
  },
  {
    number: "02",
    title: "ON CRÉE TOUT POUR VOUS",
    description: "Vidéos, visuels, site web, publicités ciblées sur les propriétaires de votre zone.",
    icon: Rocket
  },
  {
    number: "03",
    title: "VOUS RECEVEZ DES DEMANDES DE DEVIS",
    description: "Des propriétaires vous contactent avec leur projet. Vous rappelez, vous visitez, vous signez.",
    icon: Trophy
  }
];

export const ProcessSectionTravaux = () => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="mt-16 brutalist-card bg-[#FDE047] text-center max-w-4xl mx-auto">
          <h3 className="text-2xl font-black uppercase mb-4">
            PENDANT CE TEMPS, VOUS VOUS OCCUPEZ DE VOS CHANTIERS.
          </h3>
          <p className="text-xl font-bold text-black">
            <span className="italic">Nous, on remplit votre agenda de devis.</span> 🔨🏠
          </p>
        </div>
      </div>
    </section>
